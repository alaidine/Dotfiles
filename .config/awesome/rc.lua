...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioRaiseVolume", function() awful.spawn.with_shell("amixer set Master playback 5+") end), 
    awful.key({}, "XF86AudioLowerVolume", function() awful.spawn.with_shell("amixer set Master playback 5-") end),
    awful.key({}, "XF86AudioMute", function() awful.spawn.with_shell("amixer set Master toggle") end),
    awful.key({}, "XF86AudioLowerVolume", function() awful.spawn.with_shell("amixer set Master playback") end),
...
-- Autostart
awful.spawn.with_shell("feh --bg-fill ~/.dotfiles/backgrounds/tron.png")
